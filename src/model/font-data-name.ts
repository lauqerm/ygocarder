...
export const NameFontDataMap: Record<'Default' | 'Arial' | 'OCG', NameFontData> = {
    Default: {
        ...
        fontData: {
            ...
            letterDeviationMap: {
                i: { yOffset: 1, yRatio: 1.04 },
                ì: { yOffset: 1, yRatio: 1.04 },
                í: { yOffset: 1, yRatio: 1.04 },
                î: { yOffset: 1, yRatio: 1.04 },
                ï: { yOffset: 1, yRatio: 1.04 },
                ĩ: { yOffset: 1, yRatio: 1.04 },
                ī: { yOffset: 1, yRatio: 1.04 },
                ĭ: { yOffset: 1, yRatio: 1.04 },
                į: { yOffset: 1, yRatio: 1.04 },
                ǐ: { yOffset: 1, yRatio: 1.04 },
                ȉ: { yOffset: 1, yRatio: 1.04 },
                ȋ: { yOffset: 1, yRatio: 1.04 },
                ɨ: { yOffset: 1, yRatio: 1.04 },
                ɩ: { yOffset: 1, yRatio: 1.04 },
                ᵹ: { yOffset: 1, yRatio: 1.04 },
                ᵼ: { yOffset: 1, yRatio: 1.04 },
                ᶖ: { yOffset: 1, yRatio: 1.04 },
                ḭ: { yOffset: 1, yRatio: 1.04 },
                ḯ: { yOffset: 1, yRatio: 1.04 },
                ỉ: { yOffset: 1, yRatio: 1.04 },
                ị: { yOffset: 1, yRatio: 1.04 },
                I: { yOffset: 1, yRatio: 1.04 },
                Ì: { yOffset: 1, yRatio: 1.04 },
                Í: { yOffset: 1, yRatio: 1.04 },
                Î: { yOffset: 1, yRatio: 1.04 },
