...
export const PendulumNormalFontData: Record<string, Record<string, FontData>> = {
    small: {
        tcg: {
            ...DefaultTCGNormalFontData,
            fontList: [
                ...
                { bulletWidth: 18, fontSize: 19.5, lineHeight: 20.23, lineCount: 6 },
                { bulletWidth: 17, fontSize: 17.0, lineHeight: 17.40, lineCount: 7 },
                { bulletWidth: 14, fontSize: 14.7, lineHeight: 15.32, lineCount: 8 },
            ],
        },
    },
    medium: {
...
export const PendulumEffectFontData: Record<string, Record<string, FontData>> = {
    small: {
        tcg: {
            ...DefaultTCGEffectFontData,
            fontList: [
