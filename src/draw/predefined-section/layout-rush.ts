...
export const baseDrawRushLinkArrowMap = async (
...
export const baseDrawMasterLinkMapFoil = async (
    ctx: CanvasRenderingContext2D,
    globalScale: number,
    foil: string,
    withBorder: boolean,
...
export const getRushLayoutDrawFunction = ({
    canvas,
    artworkCanvas,
    backgroundCanvas,
    globalScale,
    ...
    const backgroundEffectBoxY = 862, backgroundEffectBoxX = 51;
    ...
    const resultAPI = {
        ...
        drawFrame: async () => {
            ...
            await drawAsset(topFrameCtx, `frame-rush/rush-frame-${topLeftFrame}.png`, 0, 0);
            ...
            if (
                ...
                const topRightCanvas = await applyAlphaMask(
                    `frame-rush/rush-frame-${topRightFrame}.png`,
            ...
            // await drawAsset(bottomFrameCtx, `frame-pendulum-rush/rush-frame-pendulum-${bottomLeftFrame}.png`, 0, 0);
            ...
            if (
                ...
                const bottomRightCanvas = await applyAlphaMask(
                    `frame-rush/rush-frame-${bottomRightFrame}.png`,
        ...
        drawEffectBackground: async ({ withPendulum = false, blendWithBackground = true, externalCtx = ctx }) => {
            ...
            if (withPendulum) {
                ...
                await drawAsset(
                    effectBackgroundCtx,
                    `background-rush/rush-background-text-${resolvedEffectBackground}.png`,
        ...
        drawEffectBorder: async () => {
            if (!ctx) return;
            /** Rush cards have no effect border */
        },
