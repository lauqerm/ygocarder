...
export const RushCardInputPanel = forwardRef<CardInputPanelRef, CardInputPanel>(({
    applyCardData,
    artworkCanvas,
    backgroundCanvas,
    onCropChange,
    ...
    return <div
        className={['card-info-panel card-info-panel-rush', format === 'ocg' ? 'input-ocg' : 'input-tcg'].join(' ')}
    >
        <AppHeader
