...
`,yl=e=>{let{children:t,...a}=e;return Object(O.jsxs)(vl,{className:"angle-picker-container",children:[t,Object(O.jsx)(gl.AnglePicker,{...a})]})};var xl=a(622),jl=a(623),Ol=a(624),wl=a(586),kl=a(618);const Sl=Object(Wr.b)(kl.a)`
    font-size: var(--fs);
    color: var(--color-heavy);
    cursor: pointer;
    display: inline-block;
`,Fl=e=>{let{overlayClassName:t,iconProps:a,...r}=e;const{className:n,...i}=null!==a&&void 0!==a?a:{};return Object(O.jsx)(wl.a,{overlayClassName:["explanation-overlay",null!==t&&void 0!==t?t:""].join(" "),...r,children:Object(O.jsx)(Sl,{className:["explanation-icon",null!==n&&void 0!==n?n:""].join(" "),...i})})};var Cl=a(620),Ll=a(610);const Nl=Wr.b.span`
    display: inline-flex;
    align-items: center;
...
`;var Wl=a(197),Al=a.n(Wl),Hl=a(619);const Pl=Wr.b.span`
...
`,oo=()=>{const e=Qr(),{setting:t,updateSetting:a}=Ln(e=>{let{setting:t,updateSetting:a}=e;return{setting:t,updateSetting:a}}),{exportFormat:r,resolution:n,allowHotkey:i,reduceMotionColor:l,showCreativeOption:o,showExtraDecorativeOption:s}=t;return Object(O.jsx)(lo,{className:"setting-button",$softMode:l,children:Object(O.jsx)(wl.a,{trigger:["click"],overlayClassName:"setting-button-overlay",content:Object(O.jsxs)(io,{children:[Object(O.jsx)("div",{children:Object(O.jsx)(Ll.a,{checked:l,onChange:e=>a({reduceMotionColor:e.target.checked}),children:e["setting.option.soft-mode.label"]})}),Object(O.jsx)("div",{children:Object(O.jsx)(Ll.a,{checked:s,onChange:e=>a({showExtraDecorativeOption:e.target.checked}),children:e["setting.option.extra-decorative.label"]})}),Object(O.jsx)("div",{children:Object(O.jsx)(Ll.a,{checked:o,onChange:e=>a({showCreativeOption:e.target.checked}),children:e["setting.option.creative.label"]})}),Object(O.jsx)("div",{children:Object(O.jsx)(Mr.a,{title:e["setting.option.hotkey.tooltip"],placement:"left",children:Object(O.jsx)(Ll.a,{checked:i,onChange:e=>a({allowHotkey:e.target.checked}),children:e["setting.option.hotkey.label"]})})}),Object(O.jsxs)("div",{children:[Object(O.jsx)("div",{className:"list-option",children:e["setting.option.resolution.label"]}),Object(O.jsx)(El,{className:"resolution-list",value:`${n[0]}x${n[1]}`,optionList:Kt.map(t=>{let{height:a,width:r,label:n,scale:i}=t;return{value:`${r}x${a}`,label:i>1?Object(O.jsx)(wl.a,{overlayClassName:"explanation-overlay",placement:"left",content:Object(O.jsx)(Vl,{children:e["setting.option.resolution.warning"]}),children:Object(O.jsx)(eo,{width:r,height:a,warning:!0})}):Object(O.jsx)(eo,{width:r,height:a})}}),onChange:e=>{const t=$t[e];t&&a({resolution:t.settingValue,globalScale:t.scale})}})]}),Object(O.jsxs)("div",{children:[Object(O.jsx)("div",{className:"list-option",children:e["setting.option.export-format.label"]}),Object(O.jsx)(El,{value:r,optionList:Ut,onChange:e=>{a({exportFormat:e})}})]}),Object(O.jsx)("div",{children:Object(O.jsx)("small",{children:e["setting.alert"]})})]}),children:Object(O.jsxs)("div",{className:"button-label",children:[Object(O.jsx)(Cl.a,{}),Object(O.jsx)("label",{children:e["setting.button.label"]})]})})})};var so=a(608);const co=Wr.c`
...
`,Jo=Wr.b.div`
    display: inline-block;
    width: 10px;
`,Qo=e=>{let{id:t,tabIndex:a,nameKey:r,labelBackgroundColor:n,labelBackgroundColorList:i,className:l,onClick:o}=e;const s=Qr();return Object(O.jsxs)(_o,{id:t,tabIndex:a,className:`frame-info-block ${null!==l&&void 0!==l?l:""}`,$withPillar:!(!n&&!i),onClick:o,children:[i?Object(O.jsx)(Jo,{children:i.map(e=>Object(O.jsx)("div",{style:{backgroundColor:e,height:100/i.length+"%"}},e))}):n?Object(O.jsx)(Jo,{style:{backgroundColor:n}}):null,Object(O.jsx)("label",{className:"frame-info-block-label",children:s[r]})]})};var Zo=a(602),es=a(143),ts=a(303),as=a.n(ts),rs=a(626),ns=a(627),is=a(628),ls=a(588);const os=Wr.b.div`
    display: flex;
	position: absolute;
	top: 0;
	left: 0;
...
`,xs=e=>{let{children:t,onChange:a,value:r}=e;const{color:n,inputText:i,setColor:l}=In({value:r,onChange:a}),o=""===i;return Object(O.jsxs)(ys,{className:"horizontal-sketch-picker",children:[Object(O.jsx)("div",{className:"input-label",children:t}),Object(O.jsxs)("div",{className:"color-input",children:[Object(O.jsxs)("div",{className:"color-state",children:[Object(O.jsx)(Ml,{$empty:o,style:o?{}:{backgroundColor:n.hex}}),Object(O.jsx)(Tl,{size:"sm",Icon:Pr.a,onClick:()=>{a("")}})]}),Object(O.jsx)(Zo.a,{size:"small",value:i,onChange:e=>{l(e.target.value)}})]}),Object(O.jsx)("div",{className:"color-list",children:vs.map(e=>{let{hex:t,rgb:r}=e;const i=gr(r);return Object(O.jsx)(Ml,{className:"color-block",title:t,style:{backgroundColor:t},onClick:()=>null===a||void 0===a?void 0:a(t),children:n.hex.toUpperCase()===t&&Object(O.jsx)("div",{className:"active-dot",style:{backgroundColor:i}})},t)})}),Object(O.jsx)(fs,{color:n.hex,onChange:e=>{let{hex:t}=e;return l(t)}})]})};var js=a(235),Os=a(629),ws=a(630),ks=a(631);const{height:Ss,width:Fs}=s,Cs=Wr.b.div`
    width: ${Fs}px;
    height: ${Ss}px;
    overflow: hidden;
    position: relative;
...
`,qs=Object(Wr.b)(Ar)`
    ${$l}
`,_s=e=>{let{data:t,children:a,disabled:r,withText:n}=e;return Object(O.jsx)(Ul,{disabled:r,data:t,container:qs,overlay:n?Object(O.jsxs)(O.Fragment,{children:["Copied\xa0",Object(O.jsx)(Hl.a,{})]}):Object(O.jsx)(Hl.a,{}),children:a})},Js=e=>[{label:e["button.import.for-ygocarder.label"],value:"ygocarder",converter:Ya},{label:e["button.import.for-other.label"],value:"other",converter:or}],Qs=Object(r.forwardRef)((e,t)=>{let{tainted:a,artworkCanvas:n,onRequireExportData:i,onRequireDownload:l,onClose:o}=e;const[s,c]=Object(r.useState)(!1),[d,u]=Object(r.useState)("ygocarder"),[m,b]=Object(r.useState)({other:{name:"",data:"",isPartial:!1},ygocarder:{name:"",data:"",isPartial:!1}}),{allowHotkey:p,resolution:h}=Ln(Object(Bn.useShallow)(e=>{let{setting:{allowHotkey:t,resolution:a}}=e;return{allowHotkey:t,resolution:a}})),g=Qr(),f="export-input-raw",v=Object(r.useCallback)(()=>{const e=document.getElementById(f);e&&(e.focus(),e.select())},[]);Object(r.useImperativeHandle)(t,()=>({setCardData:function(e){(!(arguments.length>1&&void 0!==arguments[1])||arguments[1])&&c(!0),b(Js(g).map(t=>{let{value:a,converter:r}=t;try{const{isPartial:t,result:i}=r(e,n);return{value:a,isPartial:t,name:Xa(e.name),data:`${JSON.stringify(i)}`}}catch(i){return console.error(i),{value:a,isPartial:!1,name:"Unknown",data:""}}}).reduce((e,t)=>{let{data:a,isPartial:r,value:n,name:i}=t;return e[n]={name:i,data:a,isPartial:r},e},{...m}))}})),Object(r.useEffect)(()=>{setTimeout(()=>{s&&"ygocarder"===d&&v()},100)},[d,v,s]);const{data:y,isPartial:x,name:j}=m[d];return Object(O.jsxs)(O.Fragment,{children:[Object(O.jsx)(Er.a,{visible:s,title:g["button.export-modal.label"],className:"global-overlay",onCancel:()=>{c(!1),o()},cancelText:g["converter.cancel.label"],okButtonProps:{style:{display:"none"}},width:600,destroyOnClose:!1,children:Object(O.jsxs)(Xs,{children:[Object(O.jsx)(El,{optionList:Js(g),onChange:e=>u(e),value:d}),"other"===d&&x&&Object(O.jsxs)("div",{className:"partial-alert",children:[Object(O.jsx)("b",{children:g["service.decode.partial.message"]}),Object(O.jsx)("br",{}),g["service.decode.partial.description"]]}),Object(O.jsxs)("div",{className:zr("export-container-result",`mode_${d}`),children:[Object(O.jsx)(Xl,{content:a&&"other"===d?Object(O.jsx)($o,{}):void 0,children:Object(O.jsx)("div",{children:Object(O.jsxs)(Ar,{disabled:a&&"other"===d,onClick:()=>{const e=new Blob([y],{type:"application/json"});_a(Xa(j),e,"application/json")},children:[Object(O.jsx)("div",{className:"icon",children:Object(O.jsx)(rs.a,{})}),Object(O.jsx)("div",{className:"label",children:g["button.export-modal.download-button.label"]})]})})}),"ygocarder"===d&&Object(O.jsx)(Xl,{placement:"bottom",content:x?Object(O.jsx)(Vl,{children:g["prompt.export.offline-warning.message"]}):void 0,children:Object(O.jsx)("div",{children:Object(O.jsxs)(_s,{disabled:!1,data:m.ygocarder.data,withText:!0,children:[Object(O.jsx)("div",{className:"icon",children:Object(O.jsx)(Ys.a,{})}),Object(O.jsx)("div",{className:"label",children:g["button.export-modal.copy-button.label"]})]})})}),"ygocarder"===d&&Object(O.jsx)(Xl,{placement:"bottom",content:x?Object(O.jsx)(Vl,{children:g["image-cropper.offline-warning"]}):void 0,children:Object(O.jsx)("div",{children:Object(O.jsxs)(_s,{disabled:x,data:window.location.href,withText:!0,children:[Object(O.jsx)("div",{className:"icon",children:Object(O.jsx)(Gs.a,{})}),Object(O.jsx)("div",{className:"label",children:g["button.export-modal.share-button.label"]})]})})}),Object(O.jsxs)("div",{children:[Object(O.jsx)(Xl,{content:a?Object(O.jsx)($o,{}):void 0,children:Object(O.jsx)("div",{children:Object(O.jsxs)(Ar,{disabled:a,className:"export-download-image",onClick:l,children:[Object(O.jsx)("div",{className:"icon",children:Object(O.jsx)(Vs.a,{})}),Object(O.jsx)("div",{className:"label",children:g["button.export-modal.save-button.label"]})]})})}),Object(O.jsx)(ul.a,{overlay:Object(O.jsx)(Es,{}),children:Object(O.jsxs)("div",{className:"resolution-picker",children:[h[0]," \xd7 ",h[1]]})})]}),"ygocarder"===d&&!x&&Object(O.jsx)(Zo.a.TextArea,{id:f,className:"export-input-raw",size:"small",value:m.ygocarder.data,rows:5})]})]})}),Object(O.jsx)(Mr.a,{overlay:p?Object(O.jsx)(O.Fragment,{children:"Ctrl-D / \u2318-D"}):null,children:Object(O.jsx)("button",{className:"primary-button export-button",onClick:()=>{i(),c(!0)},children:g["generic.export.label"]})}),Object(O.jsx)(ul.a,{overlay:Object(O.jsx)(Is.a,{onClick:e=>e.domEvent.stopPropagation(),children:Js(g).map((e,t)=>{let{converter:a,label:r}=e;return Object(O.jsx)(Is.a.Item,{onClick:()=>{try{const e=Cn.getState().card,{result:t}=a(e,n);((e,t)=>{const a=new Blob([t],{type:"application/json"});_a(Xa(e),a,"application/json")})(Xa(e.name),`${JSON.stringify(t)}`)}catch(e){console.error(e),Dr.a.error({message:g["error.export.message"],description:g["error.export.description"]})}},children:r},`${t}`)})}),children:Object(O.jsx)(Ar,{className:"secondary-button export-custom",children:Object(O.jsx)(rs.a,{})})})]})});var Zs=a(636);const ec=Wr.b.div`
    .prompt-alert {
        margin-bottom: var(--spacing-sm);
        .alert {
            color: var(--main-danger);
...
`,Ed=Wr.b.span`
    cursor: pointer;
`,Dd=Object(r.forwardRef)((e,t)=>{let{onTakePicker:a}=e;const n=Qr(),{name:i,format:l,getUpdater:o}=Cn(Object(Bn.useShallow)(e=>{let{card:{name:t,format:a},getUpdater:r}=e;return{name:t,format:a,getUpdater:r}})),s=Object(r.useRef)(null),c=Object(r.useRef)(null),d=Object(r.useMemo)(()=>o("setId"),[o]),u=Object(r.useMemo)(()=>o("name",void 0,"debounce"),[o]);return Object(r.useImperativeHandle)(t,()=>({setValue:e=>{var t,a;let{name:r,setId:n}=e;"string"===typeof r&&(null===(t=s.current)||void 0===t||t.setValue(r)),"string"===typeof n&&(null===(a=c.current)||void 0===a||a.setValue(n))}})),Object(O.jsxs)(zd,{className:"name-id-input",children:[Object(O.jsx)(fd,{ref:s,id:"name",defaultValue:i,addonBefore:Object(O.jsx)(Mr.a,{title:n["input.name.tooltip"],children:Object(O.jsx)(Ed,{onClick:()=>{navigator.clipboard.writeText(Xa(i))},children:n["input.name.label"]})}),onChange:u,onTakePicker:a}),Object(O.jsx)(fd,{ref:c,id:"set-id",defaultValue:Cn.getState().card.setId,addonBefore:Object(O.jsxs)(wd,{className:"input-label-with-button",children:[Object(O.jsx)("div",{className:"input-label",children:n["input.set-id.label"]}),Object(O.jsx)(Tl,{onClick:()=>{var e;return null===(e=c.current)||void 0===e?void 0:e.setValue((e=>Cr("ABCDEFGHIJKLMNOPQRSTUVWXYZ",4)+"-"+("OCG"===e?"JP":"EN")+Cr("0000000000111111111122222222223456789",1)+Cr("0123456789",2))(l))},Icon:kc.a,tooltipProps:{overlay:n["button.randomize.label"]}})]}),onChange:d,onTakePicker:a})]})});var Md=a(646);const{width:Wd,height:Ad}=s,Hd=Wr.b.div`
    margin-top: var(--spacing-sm);
    display: grid;
    grid-template-columns: repeat(auto-fill, minmax(55px, 1fr));
    row-gap: var(--spacing-sm);
...
`;var qu=a(237),_u=a(596),Ju=a(599),Qu=a(609),Zu=a(612);Object(qu.configure)({ignoreTags:[]});const em={EXPORT:["ctrl+d","command+d"],IMPORT:["ctrl+e","command+e"],MERGE:["ctrl+g","command+g"],VIEW:["ctrl+b","command+b"],DOWNLOAD:["ctrl+s","command+s"]},{height:tm,width:am}=s;var rm=function(){var e,t,a,n,i,l,o;const{allowHotkey:s,softMode:c,globalScale:d,resolution:u}=Ln(Object(Bn.useShallow)(e=>{let{setting:{allowHotkey:t,reduceMotionColor:a,globalScale:r,resolution:n}}=e;return{softMode:a,allowHotkey:t,globalScale:r,resolution:n}})),{isInitiating:m,isLoading:b,language:p,isMetadataReady:h,languageInfo:g,initiate:f,loadDefaultLanguage:v}=Jr(Object(Bn.useShallow)(e=>{let{isInitiating:t,isLoading:a,language:r,isMetadataReady:n,languageInfo:i,initiate:l,loadDefaultLanguage:o}=e;return{isInitiating:t,isLoading:a,language:r,isMetadataReady:n,languageInfo:i,initiate:l,loadDefaultLanguage:o}})),[y,x]=Object(r.useState)(!0),[,j]=En("activeDropzone"),[w,k]=Object(r.useState)(""),[S,F]=Object(r.useState)("online"),{db:C,dbReady:L}=Rn(),[N,T]=Object(r.useState)(!1),R=Object(r.useRef)(null),I=Object(r.useRef)(null),B=Object(r.useRef)(null),z=Object(r.useRef)(null),E=Object(r.useRef)(null),D=Object(r.useRef)(null),M=Object(r.useRef)(null),W=Object(r.useRef)(null),A=Object(r.useRef)(null),H=Object(r.useRef)(null),P=Object(r.useRef)(null),$=Object(r.useRef)(null),K=Object(r.useRef)(null),U=Object(r.useRef)(null),Y=Object(r.useRef)(null),G=Object(r.useRef)(null),V=Object(r.useRef)(null),X=Object(r.useRef)(null),q=Object(r.useRef)(null),_=Object(r.useRef)(null),J=Object(r.useRef)(null),[Q]=Object(r.useState)({artworkCanvasRef:z,backgroundCanvasRef:E,exportCanvasRef:D,frameCanvasRef:W,cardIconCanvasRef:A,pendulumScaleCanvasRef:H,pendulumEffectCanvasRef:P,typeCanvasRef:$,effectCanvasRef:K,nameCanvasRef:U,statCanvasRef:Y,setIdCanvasRef:G,passwordCanvasRef:V,creatorCanvasRef:X,stickerCanvasRef:q,finishCanvasRef:_,lightboxRef:J,previewCanvasRef:M}),Z=Object(r.useRef)(null),ee=Object(r.useRef)(null),te=Object(r.useRef)(null),[ae,re]=Object(r.useState)(0);Object(r.useEffect)(()=>{const e=()=>{j(0)};let t=window.setTimeout(e,200);const a=()=>{j(1),window.clearTimeout(t),t=window.setTimeout(e,200)};return document.addEventListener("dragover",a),()=>{document.removeEventListener("dragover",a)}},[j]),Object(r.useEffect)(()=>{f()},[f]),Object(r.useEffect)(()=>{h&&v()},[h,v]),Object(r.useEffect)(()=>{["font-family","letter-spacing","--width-label"].forEach(e=>{var t,a;document.body.style.setProperty(e,null!==(t=null===(a=g.style)||void 0===a?void 0:a[e])&&void 0!==t?t:"")})},[g]),Object(r.useEffect)(()=>{(async()=>{try{if(C&&!1===b&&p){const e=C.transaction("presetLayoutStore","readonly"),t=[];for await(const n of e.store){const{content:e,key:a}=n.value;t.push({key:a,content:JSON.parse(e)})}await e.done,zn.getState().updateGlobalMemory({layoutPresetList:t});const a=C.transaction("presetNameStyleStore","readonly"),r=[];for await(const n of a.store){const{content:e,key:t}=n.value;r.push({key:t,content:JSON.parse(e)})}await a.done,zn.getState().updateGlobalMemory({nameStylePresetList:r})}}catch(e){console.error("Error reading database",e),Dr.a.error({message:p["error.database-initialize.message"],description:p["error.database-initialize.description"]})}})()},[C,b,p]),Object(r.useEffect)(()=>{var e;const t=null===(e=D.current)||void 0===e?void 0:e.getContext("2d"),a=Cn.getState().setCard;t&&(t.setTransform(1,0,0,1,0,0),t.imageSmoothingQuality="high",Kn(t)),!1===m&&nl.a.load({custom:{families:["Matrix-Bold","MatrixBoldSmallCaps","MatrixBook","MatrixRegularSmallCaps","RoGSanSrfStd-Bd","SVN-Times New Roman Italic","StoneSerif-Italic","YuGiOhITCStoneSerifBSc","matrix","palatino-linotype-bold","stone-serif-bold","stone-serif-regular"],urls:["asset/font.css"]},active:()=>{const e=(()=>{try{const a=localStorage.getItem("card-version"),r=localStorage.getItem("card-data"),n=r?$a(JSON.parse(r)):null,i=new URLSearchParams(window.location.search).get("data");if(i){var e,t;const{card:a}=Sn(i),r=$a(a),{artSource:l,backgroundSource:o}=r;if("online"===l&&"online"===o)return Sn(i).card;const s={...r};return"offline"===l&&(s.artData=null!==(e=null===n||void 0===n?void 0:n.artData)&&void 0!==e?e:""),"offline"===o&&(s.backgroundData=null!==(t=null===n||void 0===n?void 0:n.backgroundData)&&void 0!==t?t:""),s}return null!==n&&"2.3.18"===a?n:Wt()}catch(a){return console.error(a),Wt()}})();a(e),kn.getState().setCardList([e],e.id),x(!1)},fontinactive(e,t){console.error("TCG fontinactive",e,t),Dr.a.error({message:Zr()["error.load.font.tcg"](e)})},inactive:()=>{k(Zr()["error.load.font.all-tcg"]),x(!1)}})},[m]);const{styleContent:ne}=(e=>{let{isLanguageInitiating:t,onActive:a,onBeforeLoad:n,onFontInactive:i,onInactive:l}=e;const{font:o,format:s}=Cn(Object(Bn.useShallow)(e=>({format:e.card.format,font:e.card.nameStyle.font}))),[c,d]=Object(r.useState)(""),u=Object(r.useRef)(!1),m=Object(r.useRef)(0);return Object(r.useEffect)(()=>{("ocg"===s||"OCG"===o)&&!1===u.current&&m.current<=3&&!1===t&&(m.current+=1,d("/ygocarder/asset/ocg-font.css"),n(),nl.a.load({custom:{families:["DFHSGothic-W3-WIN-RKSJ-H","DFKakuTaiHiStd-W4","FOT-Rodin Pro M","Yu-Gi-Oh! DF Leisho 3"],urls:["asset/ocg-font.css"]},active:()=>{u.current=!0,a()},inactive:()=>{u.current=!0,l()},fontinactive:i}))},[s,o,t,a,n,i,l]),{styleContent:c}})({isLanguageInitiating:m,onBeforeLoad:()=>{var e;x(!0);const t=null===(e=D.current)||void 0===e?void 0:e.getContext("2d");t&&(t.setTransform(1,0,0,1,0,0),t.imageSmoothingQuality="high",Kn(t))},onActive:()=>{x(!1)},onInactive:()=>{k(Zr()["error.load.font.all-ocg"]),x(!1)},onFontInactive:(e,t)=>{console.error("OCG fontinactive",e,t),Dr.a.error({message:Zr()["error.load.font.ocg"](e)})}}),[ie,le]=Object(r.useState)(!1);Object(r.useEffect)(()=>{const e=document.body.classList;c?e.add("reduced-color-motion"):e.remove("reduced-color-motion")},[c]);const oe=Object(r.useCallback)(function(e){var t;arguments.length>1&&void 0!==arguments[1]&&arguments[1]&&!s||null===(t=J.current)||void 0===t||t.setVisible(t=>"boolean"===typeof e?e:!t)},[s]),se=Object(r.useRef)(!1),ce=document.getElementById("sentry-bug-report");Object(r.useEffect)(()=>{ce&&p&&!1===se.current&&!1===pl.f()&&(se.current=!0,_u.a({dsn:"https://32e20d849c5724b2e63eab9d0a57c165@o4508424630697984.ingest.us.sentry.io/4508424632401920",integrations:[Ju.a(),Qu.a(),Zu.a({colorScheme:"system",autoInject:!1}).attachTo(ce,{formTitle:p["contributor.bug-report.tooltip"],nameLabel:p["contributor.bug-report.name.label"],namePlaceholder:p["contributor.bug-report.name.placeholder"],isEmailRequired:!1,showEmail:!1,messageLabel:p["contributor.bug-report.message.label"],messagePlaceholder:p["contributor.bug-report.message.placeholder"],addScreenshotButtonLabel:p["contributor.bug-report.screenshot.label"],removeScreenshotButtonLabel:p["contributor.bug-report.remove-screenshot.label"],cancelButtonLabel:p["contributor.bug-report.cancel.label"],submitButtonLabel:p["contributor.bug-report.submit.label"],isRequiredLabel:p["contributor.bug-report.required.label"],successMessageText:p["contributor.bug-report.success.label"]})],tracesSampleRate:1,tracePropagationTargets:["lauqerm.github.io"],replaysSessionSampleRate:.1,replaysOnErrorSampleRate:1}))},[p,ce]);const de=Object(r.useCallback)((e,t)=>{var a;const{addToList:r,forcePurityCheck:n,writeOnCurrentCard:i}=null!==t&&void 0!==t?t:{},{setCard:l,card:o}=Cn.getState(),s=i?{...e,id:o.id}:e;r&&kn.getState().addCard(s),l(s,n),re(e=>e+1),null===(a=B.current)||void 0===a||a.forceCardData(s),Ir()},[]),ue=Object(r.useCallback)(async function(e){var t;arguments.length>1&&void 0!==arguments[1]&&arguments[1]&&!s||(null===e||void 0===e||e.preventDefault(),null===(t=te.current)||void 0===t||t.requestImport("replace"))},[s]),me=Object(r.useCallback)(function(e){var t;arguments.length>1&&void 0!==arguments[1]&&arguments[1]&&!s||(null===e||void 0===e||e.preventDefault(),null===(t=te.current)||void 0===t||t.requestImport("merge"))},[s]),be=Object(r.useCallback)(function(e){var t;let a=arguments.length>2?arguments[2]:void 0;if(!(arguments.length>1&&void 0!==arguments[1]&&arguments[1])||s)if(null===e||void 0===e||e.preventDefault(),"online"===S&&null!==(t=B.current)&&void 0!==t&&t.isLoading())window.alert(p["error.export.image-loading.message"]);else try{var r;const e=null!==a&&void 0!==a?a:Cn.getState().card;null===(r=ee.current)||void 0===r||r.setCardData(e)}catch(n){console.error(n),Dr.a.error({message:p["error.export.message"],description:p["error.export.description"]})}},[s,p,S]),pe=Object(r.useCallback)(function(e){var t;arguments.length>1&&void 0!==arguments[1]&&arguments[1]&&!s||(null===e||void 0===e||e.preventDefault(),null===(t=Z.current)||void 0===t||t.download())},[s]),he=Object(r.useMemo)(()=>({IMPORT:e=>ue(e,!0),MERGE:e=>me(e,!0),EXPORT:e=>be(e,!0),VIEW:()=>oe(!0,!0),DOWNLOAD:e=>pe(e,!0)}),[pe,be,ue,me,oe]),ge=Object(r.useCallback)(()=>{le(!0),alert(p["prompt.download.tainted.message"])},[p]),fe=Object(r.useCallback)(e=>{var t;"anonymous"===e&&(le(!1),null===(t=J.current)||void 0===t||t.refresh());re(e=>e+1)},[]),ve=Object(r.useCallback)((e,t)=>{re(e=>e+1),F(t)},[]),ye=Object(r.useCallback)(()=>{re(e=>e+1),le(!0)},[]),xe=Object(r.useCallback)(e=>{T(e)},[]),je=b||y||!L;return Object(O.jsx)(qu.HotKeys,{keyMap:em,handlers:he,children:Object(O.jsxs)("div",{id:"app",onDrop:()=>{},onScroll:e=>{const t=e.currentTarget.scrollTop;if(R.current&&I.current){const a=document.body.clientWidth<1600?0:10,r=e.currentTarget.getBoundingClientRect().height,n=R.current.getBoundingClientRect().height;if(r>n+a){const e=Math.max(0,I.current.getBoundingClientRect().height-n);R.current.style.transform=`translateY(${Math.max(0,Math.min(e,t)-a)}px)`}else R.current.style.transform=""}},className:`language-${g.codeName} manager_${N?"visible":"hidden"}`,style:{backgroundImage:'url("/ygocarder/asset/image/texture/debut-dark.png"), linear-gradient(180deg, #00000022, #00000044)',height:Br()?"-webkit-fill-available":"100vh","--card-height":tm*d+"px","--card-width":am*d+"px","--global-scale":`${d}`,"--cropper-width":"375px"},children:[ne&&Object(O.jsx)("link",{rel:"stylesheet",type:"text/css",href:ne}),Object(O.jsxs)("div",{className:"app-container",style:{backgroundImage:'url("/ygocarder/asset/image/texture/dark-denim-3.png")'},children:[je&&Object(O.jsx)(Ku,{className:"app-loading",children:w.length>0?Object(O.jsx)(Yu,{children:w}):null!==(e=g.initialMessage)&&void 0!==e?e:""}),Object(O.jsx)("div",{ref:I,className:"card-preview-panel "+(ie?"export-tainted":"export-normal"),children:Object(O.jsxs)("div",{ref:R,className:"preview-sliding-window",children:[Object(O.jsxs)(Hu,{className:"data-button-panel",children:[Object(O.jsxs)("div",{className:"imexport",children:[Object(O.jsx)(Qs,{ref:ee,tainted:ie,artworkCanvas:z.current,onRequireExportData:be,onRequireDownload:()=>{var e;return null===(e=Z.current)||void 0===e?void 0:e.download()},onClose:Ir}),Object(O.jsx)("div",{}),Object(O.jsx)(tc,{ref:te,onImport:de,onClose:Ir,allowHotkey:s,language:p})]}),Object(O.jsx)(cl,{language:p}),Object(O.jsx)(Us,{ref:Z,canvasMap:Q,imageChangeCount:ae,isTainted:ie,isInitializing:y,globalScale:d,onDownloadError:ge}),ie&&Object(O.jsxs)("div",{id:"save-button-tainted",className:"save-button-container save-button-tainted",children:[Object(O.jsxs)("div",{className:"alert-label",children:[p["alert.download.tainted-first-line"],Object(O.jsx)("br",{}),p["alert.download.tainted-second-line"]," ",Object(O.jsx)(Ko,{})]}),Object(O.jsx)(ul.a,{className:"save-button-dropdown",placement:"bottomRight",overlay:Object(O.jsx)(Es,{onChange:()=>Ir()}),children:Object(O.jsxs)($s,{className:"resolution-option",onClick:e=>e.stopPropagation(),children:[Object(O.jsx)(ml.a,{className:"resolution-icon"}),Object(O.jsx)("span",{className:"resolution-overlay",children:u[1]})]})})]})]}),Object(O.jsxs)(Pu,{className:"card-preview-container",children:[Object(O.jsx)(Mr.a,{title:p["generic.reset.tooltip"],children:Object(O.jsx)(Xu,{className:"reset-button",onClick:()=>{if(window.confirm(p["prompt.reset.message"])){var e;const{setCard:t,card:a}=Cn.getState(),r={id:a.id,...Mt()},n="tcg"===a.format?r:Kr(r,"ocg");t(n,!0),re(e=>e+1),null===(e=B.current)||void 0===e||e.forceCardData(n)}},children:Object(O.jsx)(cc.a,{})})}),Object(O.jsx)(Mr.a,{title:Object(O.jsxs)("div",{className:"center",children:[p["button.full-size.label"],s?Object(O.jsxs)(O.Fragment,{children:[Object(O.jsx)("br",{}),"Ctrl-B / \u2318-B"]}):null]}),children:Object(O.jsx)(Vu,{className:"lightbox-button",onClick:()=>oe(),children:Object(O.jsx)(Os.a,{})})}),Object(O.jsx)("canvas",{id:"preview-canvas",ref:M,width:am,height:tm},(null!==(t=null===(a=J.current)||void 0===a?void 0:a.getCanvasKey())&&void 0!==t?t:0)+.2),Object(O.jsxs)($u,{className:"card-canvas-group",children:[Object(O.jsx)("canvas",{id:"export-canvas",ref:D,width:am*d,height:tm*d},(null!==(n=null===(i=J.current)||void 0===i?void 0:i.getCanvasKey())&&void 0!==n?n:0)+.1),Object(O.jsx)("div",{id:"export-canvas-guard",onContextMenu:e=>e.preventDefault()}),Object(O.jsx)("canvas",{id:"frameCanvas",ref:W,width:am*d,height:tm*d},null!==(l=null===(o=J.current)||void 0===o?void 0:o.getCanvasKey())&&void 0!==l?l:0),Object(O.jsx)("canvas",{id:"nameCanvas",ref:U,width:am*d,height:148*d}),Object(O.jsx)("canvas",{id:"cardIconCanvas",ref:A,width:am*d,height:222*d}),Object(O.jsx)("canvas",{id:"pendulumScaleCanvas",ref:H,width:am*d,height:920*d}),Object(O.jsx)("canvas",{id:"pendulumEffectCanvas",ref:P,width:am*d,height:920*d}),Object(O.jsx)("canvas",{id:"typeCanvas",ref:$,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"effectCanvas",ref:K,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"statCanvas",ref:Y,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"setIdCanvas",ref:G,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"passwordCanvas",ref:V,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"creatorCanvas",ref:X,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"stickerCanvas",ref:q,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{id:"finishCanvas",ref:_,width:am*d,height:tm*d}),Object(O.jsx)("canvas",{className:"crop-canvas",ref:z}),Object(O.jsx)("canvas",{className:"crop-canvas",ref:E})]})]})]})}),!1===je&&Object(O.jsx)(lu,{ref:B,artworkCanvas:z.current,backgroundCanvas:E.current,onSourceLoaded:fe,onCropChange:ve,onTainted:ye})]}),Object(O.jsx)(Mu,{language:p,onVisibleChange:xe,onSelect:de,onRequestImport:()=>{var e;null===(e=te.current)||void 0===e||e.requestImport("new")}}),Object(O.jsx)(Ns,{ref:J,globalScale:d}),Object(O.jsxs)(Uu,{className:"by-me",children:["Made by Lauqerm ",Object(O.jsx)("img",{src:"https://i.imgur.com/RY6IRqn.png",alt:"avatar"})]})]})})};var nm=e=>{e&&e instanceof Function&&a.e(3).then(a.bind(null,654)).then(t=>{let{getCLS:a,getFID:r,getFCP:n,getLCP:i,getTTFB:l}=t;a(e),r(e),n(e),i(e),l(e)})};l.a.render(Object(O.jsx)(n.a.StrictMode,{children:Object(O.jsx)(rm,{})}),document.getElementById("root")),nm()}},[[582,1,2]]]);
//# sourceMappingURL=main.ac8656bb.chunk.js.map